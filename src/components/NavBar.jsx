...
const NavBar = () => {
  ...
  const {state, subtotal /*cart*/} = useContext(CartContext);
  return (
          ...
          <div className={`${isOpen && 'hidden'}  dropdown dropdown-end`}>
            <label tabIndex={0} className="btn btn-ghost btn-circle">
              <div className="indicator">
                ...
                <span className="badge badge-md indicator-item">{state.length}</span>
              </div>
            </label>
            <div
              tabIndex={0}
            ...
            >
              <div className="card-body">
                ...
                <span className="text-info">Subtotal: S/2</span>
